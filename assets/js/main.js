		...
		Basic: {
			...
			HeaderSticky: function (){
				$(window).on("scroll", function(){
					var ScrollBar = $(this).scrollTop();
					if (ScrollBar > 150 ) {
						$(".msquare-header").addClass("header-sticky"); 
					} else {
						$(".msquare-header").removeClass("header-sticky");
					}
				});
			},
			...
			MobileMenu: function (){
				...
				$(".msquare-mobile-hamburger").on("click", function(){
					$(".msquare-mobile-menu").toggleClass("mobile-menu-active"); 
					$(this).toggleClass("active");
				});

				$(".msquare-mobile-menu ul li.has-submenu a").each(function(){
